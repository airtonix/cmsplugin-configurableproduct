...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ProductTypeIcon'
        db.create_table('cmsplugin_configurableproduct_producttypeicon', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('icon', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('large_icon', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('product_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='extended_fields', unique=True, to=orm['configurableproduct.ProductType'])),
        ))
        db.send_create_signal('cmsplugin_configurableproduct', ['ProductTypeIcon'])


    def backwards(self, orm):
        
        # Deleting model 'ProductTypeIcon'
        db.delete_table('cmsplugin_configurableproduct_producttypeicon')
    ...
    models = {
        ...
        'cmsplugin_configurableproduct.producttypeicon': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'large_icon': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'product_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'extended_fields'", 'unique': 'True', 'to': "orm['configurableproduct.ProductType']"})
        },
