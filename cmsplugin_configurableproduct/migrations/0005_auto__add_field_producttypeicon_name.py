...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cmsplugin_configurableproduct_producttypeicon', 'name', self.gf('django.db.models.fields.CharField')(default='small', max_length=128), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProductTypeIcon.name'
        db.delete_column('cmsplugin_configurableproduct_producttypeicon', 'name')
