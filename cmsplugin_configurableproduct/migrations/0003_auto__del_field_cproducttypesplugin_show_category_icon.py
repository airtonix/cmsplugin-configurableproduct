...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CProductTypesPlugin.show_category_icon'
        db.delete_column('cmsplugin_cproducttypesplugin', 'show_category_icon')


    def backwards(self, orm):
        
        # Adding field 'CProductTypesPlugin.show_category_icon'
        db.add_column('cmsplugin_cproducttypesplugin', 'show_category_icon', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
